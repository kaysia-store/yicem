...
// (removed misplaced class terminator and constants block)
    ...
    normalizeDonerCategories(categories = []) {
        ...
        this.products = (this.products || []).map(p => {
            ...
            const productsWithoutDescription = ['cd3', 'cd4', 'cd5', 'cd6', 'bd4', 'bd6', 'bd9', 'bd10'];
    ...
    renderProducts() {
        ...
        productsGrid.innerHTML = filteredProducts.map(product => {
            ...
            const hideDescription = (product.category === 'pizzalar' || product.category === 'ayvalik-tostu' || product.category === 'makarnalar' || product.category === 'pasta' || product.category === 'manti' || product.category === 'bistro' || product.category === 'icecekler');
